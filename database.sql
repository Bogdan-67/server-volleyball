...
INSERT INTO action_types (
  ...
  VALUES (
    ...
    'Мяч касается площадки соперника; Принимающая команда совершает нарушение; Ошибка в расстановке принимающей команды', 
    'Мяч не перелетает через сетку; Мяч падает за пределами площадки (или задевает антенну); Заступ падающего; Ошибка в расстановке подающей команды', 
